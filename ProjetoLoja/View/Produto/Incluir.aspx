<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Incluir.aspx.cs" Inherits="ProjetoLoja.View.Produto.Incluir" %>

<asp:Content ID="IncluirProdutoForm" ContentPlaceHolderID="MainContent" runat="server">
    <fieldset>
        <h2><b>Cadastrar</b></h2>
